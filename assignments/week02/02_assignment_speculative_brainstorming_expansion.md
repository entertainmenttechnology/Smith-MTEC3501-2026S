# MTEC 3501 – Assignment 2
**Week 2 Assignment – Due Week 3**

## Speculative Brainstorming Expansion (Individual + Peer)

### Purpose
This assignment extends the in-class speculative brainstorming work into a structured but intentionally expansive exploration phase. The goal is **not** to decide what your project will be, but to dramatically increase the number of possible directions it *could* take.

You will apply a set of distinct brainstorming techniques to your own project idea and to the ideas of your classmates, using GitHub Discussions as the shared workspace.

At this stage, **quantity, range, and boldness** matter more than feasibility, polish, or correctness.
...
What if this project were treated like a ritual instead of a tool?
How would the pacing, repetition, or symbolism change?
```
...
This speculative expansion will directly feed into:
- Project scoping
- Precedent and inspirational research
- Proof-of-concept decisions
- GitHub project tracking and issue creation

You are building *idea space* now so that later decisions are informed, intentional, and well-supported.

---

**Reminder:**
If your idea feels chaotic or unstable after this assignment, that means it is working.
