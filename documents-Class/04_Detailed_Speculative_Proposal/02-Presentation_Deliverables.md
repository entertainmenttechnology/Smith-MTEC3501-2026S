...
| **Prototype Plan (PoC Plan)** | **Description of the PoC (not built yet)** | A document explaining **what the PoC will be, its key functions, and what needs to be built first**. | **GitHub (Markdown file in each student's "Projects/[StudentName]/Prototype-Planning" folder)** |
